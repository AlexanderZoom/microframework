...
<head>
  ...
  <title><?php echo $name ?>: <?php echo htmlspecialchars($message, ENT_QUOTES, Lib_Config::getVar('app_charset')) ?></title>
  <style type="text/css">
...
<body>
  ...
  <h2 id="message"><?php echo str_replace("\n", '<br />', htmlspecialchars($message, ENT_QUOTES, Lib_Config::getVar('app_charset'))) ?></h2>
  <h2>stack trace</h2>
  <ul><li><?php echo implode('</li><li>', $traces) ?></li></ul>

  <h2>settings <a href="#" onclick="toggle('settings'); return false;">...</a></h2>
  <div id="settings" style="display: none"><?php echo $settingsTable ?></div>

  <h2>request <a href="#" onclick="toggle('request'); return false;">...</a></h2>
  <div id="request" style="display: none"><?php echo $requestTable ?></div>

  <h2>response <a href="#" onclick="toggle('response'); return false;">...</a></h2>
  <div id="response" style="display: none"><?php echo $responseTable ?></div>
  
  <h2>global vars <a href="#" onclick="toggle('globals'); return false;">...</a></h2>
  <div id="globals" style="display: none"><?php echo $globalsTable ?></div>
